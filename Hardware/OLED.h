...
/*******************移植需要修改的宏定义******************/
#define OLED_SCL_PIN   GPIO_PIN_8    // 假设 SCL 接 PB8（I2C1_SCL）
#define OLED_SCL_GPIO  GPIOB         // SCL 对应 GPIO 端口
#define OLED_SDA_PIN   GPIO_PIN_9    // 假设 SDA 接 PB9（I2C1_SDA）
#define OLED_SDA_GPIO  GPIOB         // SDA 对应 GPIO 端口
